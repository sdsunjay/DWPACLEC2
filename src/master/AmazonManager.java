...
public class AmazonManager {
	...
	public static void main(String[] args) {
		...
		System.out.println("is WPA Data ready? "+isWPADataReady);
		//if(isWPADataReady)
	...
	AmazonEC2 ec2=null; 
    	...
    	requestRequest.setSpotPrice("0.066");	//Be careful about this part  = =||
    	...
    	launchSpecification.setImageId("ami-d40ed6bd");  //Choose the Image 
    	launchSpecification.setInstanceType("cg1.4xlarge");  //Choose the Type
    	launchSpecification.setKeyName("mykp");	//Choose the public key
	    ...
	    try{
	    	...
	    	for(int i=0; i<instanceIds.size();i++)
		    {
		    	...
		    	if(isWPADataReady)
					master.StartConnectingToSlave(publicIp, 1234, spaceRange.get(i*2).toString(), spaceRange.get(i*2+1).toString());
		    }
