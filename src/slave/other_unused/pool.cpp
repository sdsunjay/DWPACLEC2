...
int main(int argc, const char *argv[]) {
   ...
   //   res = stmt -> executeQuery ("SELECT * FROM City");
     ...
     // cout << "Retrieving the result set .." << endl;
      ...
      cout << "COMMENTED OUT >> Demonstrating Prepared Statements .. " << endl << endl;
...
prep_stmt = con -> prepareStatement ("INSERT INTO City (CityName) VALUES (?)");
      ...
      con -> commit();
*/
      cout << "\nQuerying the DICT table again .." << endl;

      /* re-use result set object */
      res = NULL;
      res = stmt -> executeQuery ("SELECT * FROM DICT LIMIT 100");
